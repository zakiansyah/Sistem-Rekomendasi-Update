...
<body class="bg-gradient-warning">
                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="login.php" method="post">
                                        ...
                                        <button name="submit" type="submit" class="btn btn-warning btn-user btn-block btn-oval">
    ...
    <style>
        ...
        .btn-oval {
            border-radius: 50px;
            /* Sudut bulat membuat tombol oval */
        }

        /* Opsi untuk tampilan hover */
        .btn-oval:hover {
            opacity: 0.9;
            /* Memberikan efek hover */
            transform: scale(1.02);
            /* Sedikit membesarkan tombol saat hover */
